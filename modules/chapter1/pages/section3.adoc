...
*Kueue* solves this by introducing a cloud-native job queuing system that manages quotas, prioritization, and fair sharing across tenants. In Red Hat OpenShift AI (RHOAI), Hardware Profiles serve as the critical bridge between user workloads and this queuing system.
...
Data scientists do not need to know the name of the queue or how to label their pods. The Hardware Profile abstracts this entirely—they simply select the "Fair Share" profile from the UI.
