...
image::tiered_hardware.png[align="center", title="Hardware profiles - A Tiered Approach to Allocation"]


[IMPORTANT]
All profiles must be applied to the `redhat-ods-applications` namespace to be visible in the RHOAI Dashboard.

//  To view active hardware profiles in OpenShift - from the main dashboard url,  substitute the following replacing dashboard

// /k8s/ns/redhat-ods-applications/infrastructure.opendatahub.io~v1~HardwareProfile
