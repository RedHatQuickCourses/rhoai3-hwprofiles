= Hardware Profiles in OpenShift AI: A Comprehensive Guide
...
* *Visibility:* Decide if this profile is available to *everyone* or restricted to specific groups or projects.
